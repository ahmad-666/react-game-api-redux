...
export const SEARCH_GAME_URL = searchVal =>
  `${process.env.REACT_APP_API_URL}/games?key=${process.env.REACT_APP_API_KEY}&search=${searchVal}&page_size=${searchGameConfig.size}`;
